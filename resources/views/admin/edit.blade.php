    ...
    <div class="flex flex-col gap-4">
        ...
        <form action="{{ route('admin.store') }}" method="POST">
            ...
            <div>
                ...
                <x-text-input type="email" name="user[email]" placeholder="email@example.com" value="{{ $client->user->email }}"
            ...
            <div>
                ...
                <x-text-input type="text" name="company_name" placeholder="LUCY SRL." value="{{ $client->company_name }}"
